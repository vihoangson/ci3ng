...
angular
    .module("homer")
    .controller("AdminCustomerController", Anonymous);
    function Anonymous($scope, $injector,$filter, AbstractController) {
        ...
        AdminCustomerController.prototype = Object.create(AbstractController.prototype);
        AdminCustomerController.prototype.constructor = AdminCustomerController;

        AdminCustomerController.prototype.initData = function() {
