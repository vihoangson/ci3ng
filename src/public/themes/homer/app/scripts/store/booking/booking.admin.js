...
angular
    .module("homer")
    .controller("AdminBookingController", Anonymous);
    function Anonymous($scope, $injector,$filter, AbstractController) {
        function AdminBookingController() {
            AbstractController.apply(this, arguments.callee.caller.arguments);
        }
        AdminBookingController.prototype = Object.create(AbstractController.prototype);
        AdminBookingController.prototype.constructor = AdminBookingController;

        AdminBookingController.prototype.initData = function() {
            ...
            $scope.finishEditPopupBooking = function () {
                ...
                if ($scope.BookingVM.Booking.valmanager.IsValid) {
                    $scope.BookingVM.SetFFSave(function () {
                        ...
                        if(item==null){
                            $scope.BookingsVM.ArrBooking.push($scope.BookingVM.Booking);
