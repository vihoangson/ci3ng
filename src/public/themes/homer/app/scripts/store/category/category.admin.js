...
angular
    .module("homer")
    .controller("AdminCategoryController", Anonymous);
    function Anonymous($scope, $injector,$filter, AbstractController) {
        ...
        AdminCategoryController.prototype = Object.create(AbstractController.prototype);
        AdminCategoryController.prototype.constructor = AdminCategoryController;

        AdminCategoryController.prototype.initData = function() {
            $scope.Processing = null;
            $scope.Transition = null;
            $scope.CategorysVM = null;
            $scope.CategoryVM = null;
            $scope.ParentsVM = null;
            $scope.InitData = function () {
                ...
                var parentsvm = $injector.instantiate(ParentsViewModel);
                parentsvm.InitModel($scope.Transition, $scope.Processing);
                $scope.ParentsVM = parentsvm;
                $scope.ParentsVM.InitData();
